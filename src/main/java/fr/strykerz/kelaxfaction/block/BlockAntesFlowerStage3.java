...
import fr.strykerz.kelaxfaction.procedure.ProcedureAntesFlowerStage3UpdateTick;
...
public class BlockAntesFlowerStage3 extends ElementsKelaxfactionofficialMod.ModElement {
	@GameRegistry.ObjectHolder("kelaxfactionofficial:antes_flower_stage_3")
	public static final Block block = null;
	public BlockAntesFlowerStage3(ElementsKelaxfactionofficialMod instance) {
		super(instance, 22);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("kelaxfactionofficial:antes_flower_stage_3", "inventory"));
	}
	public static class BlockCustomFlower extends BlockFlower {
		public BlockCustomFlower() {
			...
			setResistance(0F);
			setLightLevel(0F);
			setUnlocalizedName("antes_flower_stage_3");
			setRegistryName("antes_flower_stage_3");
		}
		...
		public void updateTick(World world, BlockPos pos, IBlockState state, Random random) {
			...
			int z = pos.getZ();
			{
				...
				ProcedureAntesFlowerStage3UpdateTick.executeProcedure($_dependencies);
			}
		}
	}
}
