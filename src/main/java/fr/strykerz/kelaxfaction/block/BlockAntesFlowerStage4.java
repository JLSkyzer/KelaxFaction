...
import fr.strykerz.kelaxfaction.procedure.ProcedureAntesFlowerStage4UpdateTick;
...
public class BlockAntesFlowerStage4 extends ElementsKelaxfactionofficialMod.ModElement {
	@GameRegistry.ObjectHolder("kelaxfactionofficial:antes_flower_stage_4")
	public static final Block block = null;
	public BlockAntesFlowerStage4(ElementsKelaxfactionofficialMod instance) {
		super(instance, 23);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("kelaxfactionofficial:antes_flower_stage_4", "inventory"));
	}
	public static class BlockCustomFlower extends BlockFlower {
		public BlockCustomFlower() {
			...
			setResistance(0F);
			setLightLevel(0F);
			setUnlocalizedName("antes_flower_stage_4");
			setRegistryName("antes_flower_stage_4");
		}
		...
		public void updateTick(World world, BlockPos pos, IBlockState state, Random random) {
			...
			int z = pos.getZ();
			{
				...
				ProcedureAntesFlowerStage4UpdateTick.executeProcedure($_dependencies);
			}
		}
	}
}
