...
import fr.strykerz.kelaxfaction.procedure.ProcedureAntesFlowerStage2UpdateTick;
...
public class BlockAntesFlowerStage2 extends ElementsKelaxfactionofficialMod.ModElement {
	@GameRegistry.ObjectHolder("kelaxfactionofficial:antes_flower_stage_2")
	public static final Block block = null;
	public BlockAntesFlowerStage2(ElementsKelaxfactionofficialMod instance) {
		super(instance, 21);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("kelaxfactionofficial:antes_flower_stage_2", "inventory"));
	}
	public static class BlockCustomFlower extends BlockFlower {
		public BlockCustomFlower() {
			...
			setResistance(0F);
			setLightLevel(0F);
			setUnlocalizedName("antes_flower_stage_2");
			setRegistryName("antes_flower_stage_2");
		}
		...
		public void updateTick(World world, BlockPos pos, IBlockState state, Random random) {
			...
			int z = pos.getZ();
			{
				...
				ProcedureAntesFlowerStage2UpdateTick.executeProcedure($_dependencies);
			}
		}
	}
}
