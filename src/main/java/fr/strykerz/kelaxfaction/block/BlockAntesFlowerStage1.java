...
import fr.strykerz.kelaxfaction.procedure.ProcedureAntesFlowerStage1UpdateTick;
...
public class BlockAntesFlowerStage1 extends ElementsKelaxfactionofficialMod.ModElement {
	@GameRegistry.ObjectHolder("kelaxfactionofficial:antes_flower_stage_1")
	public static final Block block = null;
	public BlockAntesFlowerStage1(ElementsKelaxfactionofficialMod instance) {
		super(instance, 20);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("kelaxfactionofficial:antes_flower_stage_1", "inventory"));
	}
	public static class BlockCustomFlower extends BlockFlower {
		public BlockCustomFlower() {
			...
			setResistance(0F);
			setLightLevel(0F);
			setUnlocalizedName("antes_flower_stage_1");
			setRegistryName("antes_flower_stage_1");
		}
		...
		public void updateTick(World world, BlockPos pos, IBlockState state, Random random) {
			...
			int z = pos.getZ();
			{
				...
				ProcedureAntesFlowerStage1UpdateTick.executeProcedure($_dependencies);
			}
		}
	}
}
